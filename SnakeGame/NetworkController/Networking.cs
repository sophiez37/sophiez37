...
public static class Networking
{
    ...
    public static TcpListener StartServer(Action<SocketState> toCall, int port)
    {
        ...
        (Action<SocketState> Action, TcpListener Listener) arTuple = (toCall, listener);
        try
        {
    ...
    {
        (Action<SocketState>, TcpListener) arTuple = ((Action<SocketState>, TcpListener))ar.AsyncState!;
        Action<SocketState> action = arTuple.Item1;
        ...
        {
            SocketState socketState = new SocketState(action, "Error when accepting client.");
            socketState.OnNetworkAction(socketState);
        }
    ...
    public static void ConnectToServer(Action<SocketState> toCall, string hostName, int port)
    {
        ...
        try
        {
            ...
            if (!foundIPV4)
            {
                SocketState errorSocketState = new SocketState(toCall, "Couldn't find any IPV4 addresses.");
        ...
        catch (Exception)
        {
            ...
            {
                SocketState errorSocketState = new SocketState(toCall, "Host name is not a valid IP address.");
                errorSocketState.OnNetworkAction(errorSocketState);
            }
        }
        ...
        // If it takes more than 3 seconds to connect then close the socket
    ...
    private static void ConnectedCallback(IAsyncResult ar)
    {
        ...
        catch (Exception)
        {
            ...
            socketState.ErrorMessage = "Error when connecting.";
        }
    ...
    public static void GetData(SocketState state)
    {
        ...
        catch (Exception)
        {
            ...
            state.ErrorMessage = "Error when receiving data.";
    ...
    private static void ReceiveCallback(IAsyncResult ar)
    {
        ...
        try
        {
            ...
            // Dectect of the socket is cleanly closed
            if (numBytes == 0)
            {
                socketState.ErrorOccurred = true;
                socketState.ErrorMessage = "No data received.";
            }
        ...
        {
            socketState.ErrorOccurred = true;
            socketState.ErrorMessage = "Error when receiving data";
        }
    ...
    public static bool Send(Socket socket, string data)
    {
        ...
        {
            // When there's an error, close the socket before returning
            socket.Close();
            return false;
        }
    }

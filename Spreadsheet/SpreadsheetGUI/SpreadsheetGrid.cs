...
public class SpreadsheetGrid : ScrollView, IDrawable, ISpreadsheetGrid
{
    ...
    private List<Address> _foundAddress = new List<Address>();
    ...
    /// <summary>
    /// Constructs an empty SpreadsheetGrid
    /// </summary>
    ...
    /// <summary>
    /// Sets all cells in this spreadsheet to be empty
    /// </summary>
    public void Clear()
    {
        _values.Clear();
    ...
    /// <summary>
    /// Sets the value of the cell at (col, row) to be c
    /// </summary>
    /// <param name="col">Column number</param>
    /// <param name="row">Row number</param>
    /// <param name="c">Value of the cell</param>
    /// <returns>False if the address is invalid, true otherwise</returns>
    ...
    /// <summary>
    /// Gets the value of the cell at (col, row)
    /// </summary>
    /// <param name="col">Column number</param>
    /// <param name="row">Row number</param>
    /// <param name="c">Value of the specified cell</param>
    /// <returns>False if the address is invalid, true otherwise</returns>
    ...
    /// <summary>
    /// Add the address of the cell to the found address list
    /// </summary>
    /// <param name="col">Column number</param>
    /// <param name="row">Row number</param>
    public void AddToFound(int col, int row)
    {
        _foundAddress.Add(new Address(col, row));
        Invalidate();
    }

    /// <summary>
    /// Clear the found address list
    /// </summary>
    ...
    /// <summary>
    /// Sets selected cell to be at (col, row)
    /// </summary>
    /// <param name="col">Column number</param>
    /// <param name="row">Row number</param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Gets column and row numbers of selected cell
    /// </summary>
    /// <param name="col">Column number</param>
    /// <param name="row">Row number</param>
    ...
    /// <summary>
    /// Returns true if the address specified by column and row numbers is invalid
    /// </summary>
    /// <param name="col">Column number</param>
    /// <param name="row">Row number</param>
    /// <returns></returns>
    ...
    public void Draw(ICanvas canvas, RectF dirtyRect)
    {
        ...
        // Highlight all the cells found
        foreach (Address a in _foundAddress)
        {
            int foundCol = a.Col;
            int foundRow = a.Row;
            HighlightCell(canvas, foundCol, foundRow);
        }
    ...
    /// <summary>
    /// Highlights the cell at position (col, row) by color cyan
    /// </summary>
    /// <param name="canvas"></param>
    /// <param name="col"></param>
    /// <param name="row"></param>
    private void HighlightCell(ICanvas canvas, int col, int row)
    {
